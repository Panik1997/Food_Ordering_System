...
public class Main {
    ...
    public static void addToFile(Lunch obj, int n){
        try {
            ...
            filewriter.write(n + ". " + obj.lunch_name + " " + obj.lunch_price + " $\n");
            filewriter.close();
        }
            catch (IOException e){
    ...
    public static void addDrinksToFile(Drinks obj, int n){
        try {
            File file = new File("order.txt");
            FileWriter filewriter = new FileWriter(file, true);
            filewriter.write(n + ". " + obj.name_of_drink + " " + obj.price_of_drink + " $\n");
            filewriter.close();
        }
        catch (IOException e){
            System.out.println(e);
                ...
                switch(number){
                    ...
                    case 1:
                        ...
                        for(int i = 0 ; i < meals.length ; i++){
                            if(meals[i].getCountry_name().equals("Italian") ){
                                System.out.println(n+1 + ". " + meals[i].lunch_name + ", Price: " + meals[i].lunch_price + " $");
                        ...
                        if(number1 > n || number1 <= 0){
                            ...
                            System.out.println("You have chosen: \n" + italianFoodArray[number1 - 1].lunch_name + ", Price: " + italianFoodArray[number1 - 1].lunch_price + " $");
                        ...
                        if(number2 == 1){
                            ...
                            for(int i = 0; i < drinks.length ; i++){
                                System.out.println(i+1 + ". " + drinks[i].name_of_drink + ", Price: " + drinks[i].price_of_drink + " $");
                            }
                            ...
                            if(number3 > drinks.length || number3 <= 0){
                                ...
                                System.out.println("You have chosen: \n" + drinks[number3 - 1].name_of_drink + ", Price: " + drinks[number3 - 1].price_of_drink + " $\n");
                    ...
                    case 2:
                        ...
                        if(number1 > n || number1 <= 0){
                            ...
                            System.out.println("You have chosen: \n" + polishFoodArray[number1 - 1].lunch_name + ", Price: " + polishFoodArray[number1 - 1].lunch_price);
                    ...
                    case 3:
                        ...
                        if(number5 == 1){
                            ...
                            if(number6 <= drinks.length && number6 > 0){
                                System.out.println("You have chosen: \n" + drinks[number6 - 1].name_of_drink + ", Price: " + drinks[number6 - 1].price_of_drink + " $\n");
                    ...
                    case 4:
                        ...
                        if(orderArray[0] == null){
                            ...
                            for (int i = 0; i < j; i++) {
                                System.out.println(tmp + ". " + orderArray[i].lunch_name + " " + orderArray[i].lunch_price + " $");
                                bill = bill + orderArray[i].lunch_price;
                                tmp++;
                            }
                            for (int i = 0; i < m ; i++) {
                                System.out.println(tmp + ". " + drinksOrder[i].name_of_drink + " " + drinksOrder[i].price_of_drink + " $");
